<?php
// $Id: preferences.php 8108 2011-11-06 13:29:13Z beckmi $
// _LANGCODE: en
// _CHARSET : UTF-8
...
// dont change
define("_MD_AM_MODULEPREF_DOMAIN", "Module Preferences Selection");
define("_MD_AM_MODULEPREF", "Module Preferences");
define("_MD_AM_MESSAGEMODULECOPY", "The domain <strong>%s</strong> does not have any data on <strong>%s</strong><br/>Do you wish to copy the current configuration?");
...
define("_MD_AM_MESSAGECOPY", "The domains <strong>%s</strong> has no preferences for %s propogated for masking, do you wish to do this now?");
