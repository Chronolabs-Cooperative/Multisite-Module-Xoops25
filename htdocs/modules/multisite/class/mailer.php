<?php
// $Id: mailer.php 8108 2011-11-06 13:29:13Z beckmi $
//  ------------------------------------------------------------------------ //
 ...
 */
include_once XOOPS_ROOT_PATH."/modules/multisite/class/multimailer.php";
...
class MultisiteMailer
{
    ...
    function MultisiteMailer()
    {
        $this->multimailer = new MultisiteMultiMailer();
        $this->reset();
    }
