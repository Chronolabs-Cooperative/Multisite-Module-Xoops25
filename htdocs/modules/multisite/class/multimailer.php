<?php
// $Id: multimailer.php 8108 2011-11-06 13:29:13Z beckmi $
//  ------------------------------------------------------------------------ //
 ...
 *
 * @version		$Id: multimailer.php 8108 2011-11-06 13:29:13Z beckmi $
 */
 ...
 */
class MultisiteMultiMailer extends PHPMailer {
	 ...
	 * @global	$xoopsConfig
	 */
	function MultisiteMultiMailer()
	{
		global $xoopsConfig;

		$domain_handler =& xoops_getmodulehandler('domain', 'multisite');
		$xoopsMailerConfig = $domain_handler->getConfigByDomainCat(XOOPS_CONF_MAILER);
